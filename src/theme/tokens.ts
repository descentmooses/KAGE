...
export const darkTokens: ThemeTokens = {
  ...
  neonCap: '#ffffff',
  headerShadow: '0 1px 20px rgba(0,249,255,0.1)',
  ...
  modalShadow: '0 0 40px rgba(0,249,255,0.15)',
  cardBg: 'rgba(255,255,255,0.02)',
  cardBorder: 'rgba(255,255,255,0.08)',
  cardShadowCyan: '0 0 16px rgba(0,249,255,0.06)',
  cardShadowMagenta: '0 0 16px rgba(255,0,170,0.06)',
  inputBg: 'rgba(255,255,255,0.04)',
  inputBorder: 'rgba(255,255,255,0.1)',
  inputFocusShadow: '0 0 16px rgba(0,249,255,0.12)',
  btnGradient: 'linear-gradient(95deg, #00f9ff, #ff00aa)',
  btnText: '#0a0a0a',
  btnShadow: '0 0 28px rgba(0,249,255,0.45)',
